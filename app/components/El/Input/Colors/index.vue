  ...
  <div class="space-y-2">
    <div class="flex flex-col gap-2">
      ...
      <div class="flex items-center gap-4">
        ...
        <button
          type="button"
          class="inline-block w-full rounded-sm border border-green-600 bg-green-600 px-2 h-10 text-sm font-medium text-white hover:bg-green-500 focus:ring-3 focus:outline-hidden"
          @click="onAddColor"
        >
          Add
        </button>

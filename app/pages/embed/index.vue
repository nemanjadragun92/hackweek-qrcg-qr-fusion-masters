<template>
  ...
  <section>
    <!-- Hero -->
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 text-black">
      <!-- Grid -->
      <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
        <div>
          ...
          >
            Start your journey with <span class="text-orange-600">Bitly</span>
          </h1>
          <p class="mt-3 text-lg text-gray-800">
            The first link management platform that empowers your brand with
            unique and powerful <strong>QR codes</strong> that stand out from
            the rest!
          </p>
          ...
          <div class="mt-7 grid gap-3 w-full sm:inline-flex">
            <a
              class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-orange-600 text-white hover:bg-orange-700 focus:outline-hidden focus:bg-orange-700 disabled:opacity-50 disabled:pointer-events-none"
              href="#"
            >
              Get started
              <svg
          ...
          <div class="mt-6 lg:mt-10 grid grid-cols-2 gap-x-5">
            ...
            <div class="py-5">
              ...
              <div class="mt-5">
                <!-- Star -->
                <svg
                  class="h-auto w-16 text-gray-800"
                  width="80"
                  height="27"
                  viewBox="0 0 80 27"
                  fill="none"
        ...
        <div class="relative ms-4">
          <div class="relative">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
              <iframe
                width="550"
                height="550"
                src="/share?config="
          ...
          <div
            class="absolute inset-0 -z-1 bg-linear-to-tr from-gray-200 via-white/0 to-white/0 size-full rounded-md mt-4 -mb-4 me-4 -ms-4 lg:mt-6 lg:-mb-6 lg:me-6 lg:-ms-6"
          ></div>
